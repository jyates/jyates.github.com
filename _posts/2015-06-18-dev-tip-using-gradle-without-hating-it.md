...
subtitle:
description: Gradle is starting to become mature enough to be used as a 'real deal' build system. However, when trying to build with gradle there can be some easy idioms to help you up the learning curve
...
```
/myproject-1.1.0-SNAPSHOT   // basename + version as we defined in the gradle.prroperties
../bin
